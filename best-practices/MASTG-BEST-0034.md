...
If untrusted data must be displayed inside web content, avoid HTML and JavaScript injection patterns such as `innerHTML` or string built `evaluateJavaScript` calls. Prefer safe text only rendering and context appropriate escaping.
